...
<p align="center" style="margin-top: 25px">
  ...
  <a href="#installation"><strong>Insallation</strong></a>

  <a href="#maintenance"><strong>Maintenance</strong></a>

  <a href="#tips--tricks"><strong>Tips & Tricks</strong></a>
...
<br/>
  ...
  ✨ *Open WebUI* - ChatGPT-like interface to pivately interact with your agents

  ✨ *Qdrant* - Open-source, high performance vector store with an comprehensive API

  ✨ *Postgres* -  Workhorse of the Data Engineering world, handles large amounts of data safely.
...
<br/>
  ...
  ![OpenWebUI](https://static.atakumi.com/Agents%20Kit/openweui.svg)
...
<br/>
  ...
  ![Qdrant](https://static.atakumi.com/Agents%20Kit/qdrant-logo.svg)
...
<br/>
  ...
  ![PostgreSQL](https://static.atakumi.com/Agents%20Kit/postgresql_logo.svg) 
  ...
  Discover how Postgres is transforming AI applications! This powerful, open-source database seamlessly integrates with AI processes, offering unparalleled performance and scalability. Postgres helps manage and analyze massive datasets efficiently, ensuring your AI models operate at their best. Its flexible architecture supports various AI workloads, making it ideal for everything from simple queries to complex data manipulations. Harness the robust capabilities of Postgres to enhance your AI projects and unlock new possibilities for innovation and growth!

  In essence, Qdrant's focus is on specialized vector search capabilities, while Postgres excels in managing structured and semi-structured data, offering a broader range of database functionalities.
<br/>

<br/>

  ![n8n](https://static.atakumi.com/Agents%20Kit/n8n_logo.svg) 
  ...
  We selected n8n over any other because of it's:
...
<br/>
 ...
 ![Ollama](https://static.atakumi.com/Agents%20Kit/ollama_logo.svg)
...
<br/>
  ...
  In Coolify, click on redeploy. Coolify will automatically restart the system and download the lastest releases.
